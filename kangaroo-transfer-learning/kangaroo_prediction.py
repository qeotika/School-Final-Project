...
def identify_volume_maskrcnn(top_picture,side_picture,voxel_size):
    ...
    image_top = cv2.imread(top_picture)
    ...
    #Side picture
    # load the input image, convert it from BGR to RGB channel
    image_side = cv2.imread(side_picture)
    ...
    created_volume3d = create_3d_volume(reduced_mask_top, reduced_mask_side)
    # create_3d_plot(created_volume3d)
    volume3d = calculate_volume(created_volume3d, voxel_size)
    
    # return volume3d,mask_data_top,mask_data_side
    return volume3d
# top = "C:/Programming PYTHON/MarkRcnn37Dig/Mask-RCNN-TF2/RiceChickenWings.jpg"
# side ="C:\Programming PYTHON\MarkRcnn37Dig\Mask-RCNN-TF2\kangaroo-transfer-learning\linoypictrials\chickenside.jpeg"
# top_data,side_data = identify_volume_maskrcnn(top,side,(1,1,1))
